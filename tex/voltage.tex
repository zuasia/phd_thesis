...
\begin{figure}
\centering
      \includegraphics[trim=5 0 10 0,clip,width=0.9\linewidth]{graphs/voltage/cpm_process_variation.pdf}
...
\begin{figure}
  \centering
  \includegraphics[trim=0 0 0 0,clip,width=0.9\linewidth]{graphs/voltage/cpm_scale_variation.pdf}
