...
\centering
  \subfloat[Undervolting mode.] {
    \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/power_saving_variation.pdf}
    \label{fig:pwrvariation} 
  }
  \subfloat[Overclocking mode.] {
    \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/freq_saving_variation.pdf}
...
\centering
      \subfloat[p0 core 0.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_process_variation_p0c0.pdf}
        \label{fig:cpmsensitivity_p0c0}
      }
      \hfill
      \subfloat[p0 core 1.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_process_variation_p0c1.pdf}
        \label{fig:cpmsensitivity_p0c1} 
      }

      \subfloat[p0 core 2.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_process_variation_p0c2.pdf}
        \label{fig:cpmsensitivity_p0c2} 
      }
      \hfill
      \subfloat[p0 core 3.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_process_variation_p0c3.pdf}
        \label{fig:cpmsensitivity_p0c3} 
      }

      \subfloat[p0 core 4.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_process_variation_p0c4.pdf}
        \label{fig:cpmsensitivity_p0c4} 
      }
      \hfill
      \subfloat[p0 core 5.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_process_variation_p0c5.pdf}
        \label{fig:cpmsensitivity_p0c5} 
      }

      \subfloat[p0 core 6.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_process_variation_p0c6.pdf}
        \label{fig:cpmsensitivity_p0c6} 
      }
      \hfill
      \subfloat[p0 core 7.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_process_variation_p0c7.pdf}
        \label{fig:cpmsensitivity_p0c7} 
      }
...
\centering
      \subfloat[p0 core 0.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_scale_variation_p0c0.pdf}
        \label{fig:cpm-variation_p0c0}
      }
      \hfill
      \subfloat[p0 core 1.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_scale_variation_p0c1.pdf}
        \label{fig:cpm-variation_p0c1} 
      }

      \subfloat[p0 core 2.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_scale_variation_p0c2.pdf}
        \label{fig:cpm-variation_p0c2} 
      }
      \hfill
      \subfloat[p0 core 3.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_scale_variation_p0c3.pdf}
        \label{fig:cpm-variation_p0c3} 
      }

      \subfloat[p0 core 4.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_scale_variation_p0c4.pdf}
        \label{fig:cpm-variation_p0c4} 
      }
      \hfill
      \subfloat[p0 core 5.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_scale_variation_p0c5.pdf}
        \label{fig:cpm-variation_p0c5} 
      }

      \subfloat[p0 core 6.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_scale_variation_p0c6.pdf}
        \label{fig:cpm-variation_p0c6} 
      }
      \hfill
      \subfloat[p0 core 7.] {
        \includegraphics[trim=0 0 0 0,clip,width=.4\linewidth]{graphs/voltage/cpm_scale_variation_p0c7.pdf}
        \label{fig:cpm-variation_p0c7} 
      }
      \caption{On-chip voltage drop analysis across cores under different workloads.}
      \label{fig:cpm-variation}  
\end{figure}
