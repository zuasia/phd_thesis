...
This chapter provides retrospective and prospective views of my dissertation work. The retrospective part (\Sec{sec:conc:retro}) distills three principles developed from my work on managing highly efficient active timing margin system. The prospective part (\Sec{sec:conc:pros}) suggests next steps for generalizing the principles and outlines lucrative research items.
