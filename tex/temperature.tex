...
\centering
  ...
  \hfill
  \begin{minipage}{0.45\textwidth}
	  \includegraphics[trim=0 -10 0 0,clip,width=0.95\linewidth]{graphs/temperature/explore-extrapolate.pdf}
...
\begin{figure*}[t!]
  ...
  {
    \includegraphics[trim=0 0 40 0,clip,width=0.3\linewidth]{graphs/temperature/FFT-diff-factor.pdf}
    \label{fig:scale-FFT}
  }
  \endgroup
\hfill
  ...
  {
    \includegraphics[trim=0 0 40 0,clip,width=0.3\linewidth]{graphs/temperature/particlefilter-diff-factor.pdf}
...
\hfill
  ...
  {
    \includegraphics[trim=0 0 40 0,clip,width=0.3\linewidth]{graphs/temperature/Reduction-diff-factor.pdf}
