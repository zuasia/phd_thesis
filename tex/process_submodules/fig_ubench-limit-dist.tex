...
%         \includegraphics[trim=0 0 0 0,clip,width=.15\linewidth]{graphs/process/ubench-limit-dist/fp-limit-dist-p0c3.pdf}
%       }
%       \hfill
%       \subfloat[p0 core4, \bench{daxpy}] {
%         \includegraphics[trim=0 0 0 0,clip,width=.15\linewidth]{graphs/process/ubench-limit-dist/fp-limit-dist-p0c4.pdf}
%       }
%       \hfill
%       \subfloat[p1 core3, \bench{stream}] {
%         \includegraphics[trim=0 0 0 0,clip,width=.15\linewidth]{graphs/process/ubench-limit-dist/mem-limit-dist-p1c3.pdf}
%       }
%       \hfill
%       \subfloat[p1 core4, \bench{stream}] {
%         \includegraphics[trim=0 0 0 0,clip,width=.15\linewidth]{graphs/process/ubench-limit-dist/mem-limit-dist-p1c4.pdf}
%       }
%       \hfill
%       \subfloat[p1 core5, \bench{coremark}] {
%         \includegraphics[trim=0 0 0 0,clip,width=.15\linewidth]{graphs/process/ubench-limit-dist/int-limit-dist-p1c5.pdf}
%       }
%       \hfill
%       \subfloat[p1 core7, \bench{coremark}] {
%         \includegraphics[trim=0 0 0 0,clip,width=.15\linewidth]{graphs/process/ubench-limit-dist/int-limit-dist-p1c7.pdf}
%       }
